...
public class Application2 {
	...
	private void initialize() {
		...
		password.setBounds(309, 76, 150, 25);
		frmSignup.getContentPane().add(password);
		
		password1 = new JPasswordField();
		password1.setFont(new Font("Times New Roman", Font.BOLD, 13));
		password1.setHorizontalAlignment(SwingConstants.CENTER);
		password1.setBounds(309, 104, 150, 25);
		...
		btnNewButton.setBounds(176, 154, 100, 20);
		...
		btnNewButton_1.setBounds(287, 154, 100, 20);
		...
		lblNewLabel_3.setBounds(190, 11, 97, 26);
		...
		textField.setBounds(309, 192, 150, 25);
		...
		passwordField.setBounds(309, 223, 150, 25);
		...
		btnNewButton_3.setIcon(new ImageIcon("D:\\code\\javacode\\WindowBuilder_SDB\\arrow.png"));
		btnNewButton_3.setBounds(0, 128, 26, 93);
		frmSignup.getContentPane().add(btnNewButton_3);
		
		JLabel lblNewLabel_4 = new JLabel("");
		lblNewLabel_4.setIcon(new ImageIcon("D:\\code\\javacode\\WindowBuilder_SDB\\img.jpg"));
