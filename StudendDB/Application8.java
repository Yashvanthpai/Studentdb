...
public class Application8 {
	...
	private void initialize() {
		...
		btnNewButton.setIcon(new ImageIcon("D:\\code\\javacode\\WindowBuilder_SDB\\arrow.png"));
		...
		lblBranch.setBounds(63, 76, 100, 25);
		...
		lblCollegeName.setBounds(63, 107, 100, 25);
		frmMarksCard.getContentPane().add(lblCollegeName);
		
		JLabel lblRegNo = new JLabel("Sem:");
		lblRegNo.setBackground(Color.BLACK);
		lblRegNo.setForeground(Color.BLACK);
		lblRegNo.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblRegNo.setHorizontalAlignment(SwingConstants.CENTER);
		lblRegNo.setBounds(350, 44, 100, 25);
		...
		text13.setBounds(170, 242, 150, 25);
		...
		text15.setBounds(170, 273, 150, 25);
		...
		text17.setBounds(170, 304, 150, 25);
		...
		text19.setBounds(170, 334, 150, 25);
		...
		text111.setBounds(170, 365, 150, 25);
		...
		text12.setBounds(418, 211, 150, 25);
		...
		text14.setBounds(418, 242, 150, 25);
		...
		text16.setBounds(418, 273, 150, 25);
		...
		text18.setBounds(418, 304, 150, 25);
		...
		text110.setBounds(418, 334, 150, 25);
		...
		btnPrint.setBounds(541, 445, 125, 26);
		frmMarksCard.getContentPane().add(btnPrint);
		
		textField = new JTextField();
		textField.setFont(new Font("Times New Roman", Font.BOLD, 14));
		textField.setHorizontalAlignment(SwingConstants.CENTER);
		textField.setBounds(306, 402, 125, 25);
		...
		lblNewLabel_2.setBounds(199, 402, 100, 25);
		frmMarksCard.getContentPane().add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("");
		lblNewLabel_3.setIcon(new ImageIcon("D:\\code\\javacode\\WindowBuilder_SDB\\img.jpg"));
